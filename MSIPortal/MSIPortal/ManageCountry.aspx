<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="ManageCountry.aspx.cs" Inherits="MSIPortal.ManageCountry" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="2" Width="100%"
            CssClass="MyTabStyle">
            <asp:TabPanel ID="TabPanelCreateCountry" runat="server" HeaderText="TabPanel2">
                <HeaderTemplate>
                    Create Country</HeaderTemplate>
                <ContentTemplate>
                    <div class="well">
                        <div class="control-group">
                            <label class="control-label" for="input_email">
                                Country Name <sup>*</sup></label>
                            <div class="controls">
                                <asp:TextBox ID="txtCountry" placeholder="Country Name" runat="server"></asp:TextBox>
                                <asp:Label ID="vmCountryName" runat="server" ForeColor="Red"></asp:Label>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="controls">
            ...
            <asp:TabPanel ID="TabPanelCountryList" runat="server" HeaderText="TabPanel3">
                <HeaderTemplate>
                    Country List</HeaderTemplate>
                <ContentTemplate>
                    <div class="well">
                        <asp:GridView ID="GridView1" runat="server" CssClass="gridview" GridLines="None"
                            ...
                            <Columns>
                                <asp:BoundField HeaderText="SL No" DataField="CountryId" ReadOnly="True" />
                                <asp:BoundField HeaderText="Country Name" DataField="CountryName" ReadOnly="True" />
                                <asp:TemplateField HeaderText="Edit">
                                    <ItemTemplate>
                                        <asp:Button ID="btnEdit" CommandName="Modify" CommandArgument='<%# Eval("CountryId") %>'
            ...
            <asp:TabPanel ID="TabPanelEditCountry" runat="server" HeaderText="TabPanel4">
                <HeaderTemplate>
                    Edit Country</HeaderTemplate>
                <ContentTemplate>
                    <div class="well">
                        <h5>
                            Country Edit</h5>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <asp:TextBox ID="txtCountryForEdit" runat="server"></asp:TextBox>
                                <asp:Label ID="lblCountryValidationEdit" runat="server" ForeColor="Red"></asp:Label>
                            </div>
                        </div>
                        <div class="control-group">
                            <div class="controls">
                    ...
                    <script type="text/javascript">
                        ...
                        function ValidateForm() {
                            ...
                            if (document.getElementById('<%=txtCountryForEdit.ClientID%>').value == "0") {
                                document.getElementById('<%=lblErrorMessage.ClientID%>').innerHTML = "Country required";
                                document.getElementById('<%=lblCountryValidationEdit.ClientID%>').innerHTML = "*";
                                document.getElementById('<%=txtCountryForEdit.ClientID%>').focus();
                                return false;
                            }
                        ...
                        function ClearValidationMark() {
                            ...
                            if (document.getElementById('<%=txtCountryForEdit.ClientID%>').value != "") {
                                document.getElementById('<%=lblCountryValidationEdit.ClientID%>').innerHTML = "";
