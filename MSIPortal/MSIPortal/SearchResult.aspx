<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="SearchResult.aspx.cs" Inherits="MSIPortal.SearchResult" %>
    ...
    <ContentTemplate>
     ...
     <div class="well">
        ...
        <div style="height:30px;">  
            ...
            <strong>
            <asp:Label ID="lblPsName" runat="server" Font-Size="Medium"></asp:Label> 
            &#8658;  
           ...
           &#8658; 
             <asp:Label ID="lblNumberofRecord" runat="server"> </asp:Label>      
         ...
         <%--   <form id="form1" runat="server">--%>
            <asp:GridView ID="GridView1" runat="server" CssClass="gridview" GridLines="None"
                ShowHeader="false" AlternatingRowStyle-CssClass="even" 
